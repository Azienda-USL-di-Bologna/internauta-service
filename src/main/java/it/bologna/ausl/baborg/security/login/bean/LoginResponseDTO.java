package it.bologna.ausl.baborg.security.login.bean;

import com.fasterxml.jackson.databind.annotation.JsonSerialize;
import it.bologna.ausl.baborg.security.UserTokenState;
import it.bologna.ausl.baborg.rest.commons.message.MessageStatus;
import it.bologna.ausl.baborg.rest.commons.message.WithMessageStatus;
