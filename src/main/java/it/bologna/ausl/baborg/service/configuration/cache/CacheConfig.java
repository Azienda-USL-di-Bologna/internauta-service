package it.bologna.ausl.baborg.service.configuration.cache;
...
public class CacheConfig {
    ...
    @Value("${baborg.cache.redis.host}")
    private String redisHost;
    @Value("${baborg.cache.redis.port:6379}")
    private Integer redisPort;
    @Value("${baborg.cache.redis.expiration-seconds:7200}")
    private Integer expireTime;
    @Value("${baborg.cache.redis.use-json:false}")
    private Boolean jsonSerialization;
    @Value("${baborg.cache.redis.timeout-millis}")
