package it.bologna.ausl.baborg.service.configuration.authorization;

import it.bologna.ausl.baborg.service.authorization.jwt.AuthorizationUtils;
import it.bologna.ausl.baborg.service.authorization.jwt.JwtFilter;
...
public class RegistrationBean {
    ...
    @Value("${baborg.security.start-node-protection}")
