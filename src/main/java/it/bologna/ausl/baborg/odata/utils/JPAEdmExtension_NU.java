package it.bologna.ausl.baborg.odata.utils;
...
import it.bologna.ausl.baborg.odata.annotation.SAPLineItem;
import it.bologna.ausl.baborg.odata.annotation.Sap;
...
//@Service
public class JPAEdmExtension_NU implements org.apache.olingo.odata2.jpa.processor.api.model.JPAEdmExtension {
	...
	public InputStream getJPAEdmMappingModelStream() {
		return JPAEdmExtension_NU.class.getClassLoader().getResourceAsStream(MAPPING_MODEL);
	}
