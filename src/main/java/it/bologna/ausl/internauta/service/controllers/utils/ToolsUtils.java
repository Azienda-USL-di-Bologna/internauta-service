...
public class ToolsUtils {
    ...
    public String buildMailForCustomerSupport(Segnalazione segnalazioneUtente) {
    ...
    public String buildMailForUser(String bodyCustomerSupport) {
        
        String body = "";
        body +=
            "Gent.le Utente\n" +
            "La tua segnalazione è stata inviata al servizio Babelcare. \n" +
            "Al più presto sarai contattato da un operatore dedicato per approfondire il problema oppure "
