...
public class BolloVirtualeManager {
    ...
    public static String queryGetDatiBolliVirtuali() {
        String query = "--- procton\n"
                ...
                + "s.nome_struttura as nome_struttura\n"
                ...
                + "and pd.data_protocollo::date >= :from\n"
                + "and pd.data_protocollo::date <= :to\n"
                + "UNION\n"
                + "--- dete\n"
                + "SELECT bv.tipo_oggetto as tipo_oggetto_bollo,\n"
                ...
                + "LEFT JOIN procton.strutture s ON s.id_struttura = dd.id_struttura\n"
                + "WHERE dd.numero IS NOT null\n"
                + "and dd.data_adozione::date >= :from\n"
                + "and dd.data_adozione::date <= :to\n"
                + "UNION\n"
                + "--- deli\n"
                + "SELECT bv.tipo_oggetto as tipo_oggetto_bollo,\n"
                + "dd.codice_registro as codice_registro_doc,\n"
                ...
                + "LEFT JOIN procton.utenti pu ON da.id_utente = pu.id_utente\n"
                + "LEFT JOIN procton.strutture s ON s.id_struttura = dd.id_struttura_proponente\n"
...
//        mappings.put("guid_oggetto_origine_doc", "guidOggettoOrigineDoc");
        ...
        mappings.put("nome_struttura", "nomeStruttura");
        return mappings;
    }
}
