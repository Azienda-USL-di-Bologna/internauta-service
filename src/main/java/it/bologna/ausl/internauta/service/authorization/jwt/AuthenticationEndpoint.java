...
public class AuthenticationEndpoint {
    ...
    @Value("${internauta.authorizations-utils.public-cert-babel-test.location}")
    private String fileResourceTest;

    @Value("${internauta.authorizations-utils.public-cert-babel-prod.location}")
    private String fileResourceProd;
...
//       
        ...
        switch (mode.toLowerCase()) {
            case "test":
                fileResource = fileResourceTest;
                break;
            case "prod":
                fileResource = fileResourceProd;
                break;
            default:
                throw new ServletException("invalid mode for create cert");
        }
        
        try (FileInputStream fis = new FileInputStream(fileResource)) {
