...
//                + " FROM responsabili_old i"
                ...
                + " LEFT JOIN responsabili_old o ON o.id_archivio = i.id_archivio"
                + " WHERE o.id_archivio IS NOT NULL OR NOT EXISTS (SELECT 1 FROM scripta.attori_archivi att WHERE att.id_archivio = i.id_archivio AND att.id_persona = ?2 AND att.ruolo = 'RESPONSABILE'\\:\\:scripta.ruolo_attore_archivio)"
    ...
    @Query(value = 
        ...
        + " SELECT DISTINCT a.id_archivio, p.id_persona, 'VICARIO'\\:\\:scripta.ruolo_attore_archivio"
