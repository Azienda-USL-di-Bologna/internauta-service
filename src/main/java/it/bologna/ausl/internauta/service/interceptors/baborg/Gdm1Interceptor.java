 ...
 */
@Component
@NextSdrInterceptor(name = "gdm1-interceptor")
public class Gdm1Interceptor extends InternautaBaseInterceptor{
    private static final Logger LOGGER = LoggerFactory.getLogger(Gdm1Interceptor.class);
