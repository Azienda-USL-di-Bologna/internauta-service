...
public class PermessiController implements ControllerHandledExceptions {
     ...
     * Riceve una lista di PermessoEntitaStoredProcedure e chiama direttamente 
     * la managePermissions la quale di fatto passaeta la lista di 
     * PermessoEntitaStoredProcedure alla store procedute.
     * 
    ...
    /**
     * E' il controller che gestisce i permessi per i Gestori PEC.
     * Prima della chiamata alla Black Box viene controllato che l'utente 
     * loggato sia autorizzato a gestire la PEC e la persona. In particolare:
     * - Il CI può gestire qualunque PEC e persona.
     * - Il CA può:
     *      - Gestire PEC collegate all'azienda di cui è CA.
     *      - Gestire persone che abbiano un utente attivo 
     *        nell'azienda di cui è CA.
     * 
     * @param json  - Contiene tre oggetti:
     *  1 - persona   - E' la persona che sta ricevendo il permesso
     *  2 - pec       - E' la pec su cui il soggetto avrà il permesso.
     *                  Avrà la pecAziendaList già espansa, con l'idAzienda
     *                  già espanso. 
     *  3 - permesso  - E' di tipo PermessoStoredProcedure, conterrà 
     *                  predicato, originePermesso.
     * @param request
     * @throws BlackBoxPermissionException 
     * @throws it.bologna.ausl.internauta.service.exceptions.HttpInternautaResponseException 
     */
    ...
    /**
     * E' il controller che gestisce i permessi per le associazioni PEC-Struttura.
     * Prima della chiamata alla Black Box viene controllato che l'utente 
     * loggato sia autorizzato a gestire la PEC e la struttura. In particolare:
     * - Il CI può gestire qualunque PEC e struttura.
     * - Il CA può:
     *      - Gestire PEC collegate all'azienda di cui è CA.
     *      - Gestire strutture che appartengano all'azienda di cui è CA.
     * 
     * @param json - Contiene tre oggetti:
     *  1 - struttura - E' la struttura che sta ricevendo il permesso
     *  2 - pec       - E' la pec su cui il soggetto avrà il permesso.
     *                  Avrà la pecAziendaList già espansa, con l'idAzienda
     *                  già espanso. 
     *  3 - permesso  - E' di tipo PermessoStoredProcedure, conterrà 
