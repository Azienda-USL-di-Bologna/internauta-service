...
public class FirmePersonaInterceptor extends InternautaBaseInterceptor {
            ...
            if (firmePersona.getTipo() == FirmePersona.TipoFirma.REMOTA) {
                ...
                if (firmePersona.getTramite() == FirmePersona.TramiteFirma.ARUBA) {
                    ...
                    if (isCredentialProxyActive) {
                        ...
                        ArubaUserInformation arubaUserInfoOld = new ArubaUserInformation();
                        ...
                        try {
                            haveCredentialsBeenSet = createOrSetCredentialInCredentialProxy(azienda, arubaUserInfo, arubaUserInfoOld, FirmaRemotaInformation.FirmaRemotaProviders.ARUBA);
        ...
        if (firmePersona.getAdditionalData().getAutenticazione() != null && firmePersona.getTipo() == FirmePersona.TipoFirma.REMOTA) {
            ...
            if (firmePersona.getTramite() == FirmePersona.TramiteFirma.ARUBA) {
                ...
                if (isCredentialProxyActive) {
                    ...
                    haveCredentialBeenRemoved = removeCredentialFromCredentialProxy(azienda, arubaUserInfo, FirmaRemotaInformation.FirmaRemotaProviders.ARUBA);
    ...
    * nuove non siano valide
     */
    private Boolean createOrSetCredentialInCredentialProxy(Azienda azienda, UserInformation userInformation, UserInformation userInformationOld, FirmaRemotaInformation.FirmaRemotaProviders provider) throws FirmaRemotaException, FirmaRemotaConfigurationException, FirmaModuleException {
...
//  Chiedo se già esistono queste credenziali
            ...
            if (existingCredentials) {
                try {
                    ...
                    throw new FirmaRemotaException("Errore nella rimozione delle credenziali");
                }
            }
