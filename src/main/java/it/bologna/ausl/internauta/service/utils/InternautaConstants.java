...
public class InternautaConstants {
    ...
    public static class Permessi {
        ...
        public enum Predicati {
            CONNESSO, CREA_GEDI, REDIGE, FIRMA, AGFIRMA, DG, DS, DSC, DA, RISERVA, ELIMINA, VISUALIZZA, MODIFICA, BLOCCO, RISPONDE, LEGGE, SPEDISCE, SPEDISCE_PRINCIPALE, DELEGA, ACCESSO, SEGR
        }
