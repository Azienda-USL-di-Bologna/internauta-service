...
//                Expressions.booleanTemplate("tools.array_overlap({0}, string_to_array({1}, ','))=true", bmenu.aziende, idAzienda)       
//            )
//        );
//        
...
//     */
//    public List<ItemMenu> buildMenu(Persona persona) throws BlackBoxPermissionException {
//        
