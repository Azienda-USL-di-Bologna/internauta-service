...
public interface CustomArchivioRecenteWithIdArchivioDetail extends ArchivioRecenteWithIdArchivio {
    ...
    @Value("#{@projectionsInterceptorLauncher.lanciaInterceptor(target, 'getIdArchivio', 'CustomArchivioDetailExtended')}")
    public CustomArchivioDetailExtended getIdArchivio();
}
